...
function trimCell(text: string, absoluteStart: number): TableCell {
  ...
  return {
    ...
    // Exclusive end: points to the position after the last code unit of content.
    // This ensures surrogate pairs (e.g., emoji) are fully included without trailing whitespace.
