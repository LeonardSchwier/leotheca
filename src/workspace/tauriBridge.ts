...
export const writeWorkspaceTextFile = impl.writeWorkspaceTextFile;
export const writeWorkspaceBinaryFile = impl.writeWorkspaceBinaryFile;
export const createWorkspaceDir = impl.createWorkspaceDir;
export const renameWorkspacePath = impl.renameWorkspacePath;
export const deleteWorkspacePathPermanent = impl.deleteWorkspacePathPermanent;
